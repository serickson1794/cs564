...
<div class="body">
	<%
		...
		try {
			...
			if (metroArea.first())
				metroAreaName = metroArea.getString("name");
			...
			for (int col = 1; col <= 3; col++) {
				...
				if (col == 1)
					htmlWriter.printOpenTag("div", "column leftColumn");
				else if (col == 2)
					htmlWriter.printOpenTag("div", "column centerColumn");
				else if (col == 3)
					htmlWriter.printOpenTag("div", "column rightColumn");
				...
				query = "SELECT business.id, business.name, business.address, business.city, business.state, business.postal_code, "
						...
						+ " WHERE postal_code.metro_area_id = " + metroAreaId + " AND business.category_id = " + col
						+ " AND business.is_open = 1" + " GROUP BY business.id"
						+ " ORDER BY review_stars DESC, review_count DESC" + " LIMIT 5;";
