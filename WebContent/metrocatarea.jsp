...
<div class="body">
	<%
		...
		try {
			...
			if (metroAreaId == null || categoryId == null)
			...
			query = "SELECT business.id, business.name, business.address, business.city, business.state, business.postal_code, "
					...
					+ " WHERE postal_code.metro_area_id = " + metroAreaId + " AND business.category_id = "
					+ categoryId + " AND business.is_open = 1" + " GROUP BY business.id"
					+ " ORDER BY review_stars DESC, review_count DESC" + " LIMIT 1000;";
